...
/**
    Build the plotly graphs. If data and layout is set,
    set them into the parameters.
**/
function buildGraph(){
...
/**
    Autopopulate with an example of data involving bananas and oranges.
    (Rows are new lines, columns are tabs. The first column should be the x-axis).
**/
...
/**
    When the user makes changes to the textarea where data is held,
    parse the data and update the graph.
**/
...
/**
    Let the user tab inside the textarea instead of exiting and moving to the next
    form object.
**/
...
/**
    Update the graph title when user makes a change to the title field.
**/
...
/**
    Update the source when user makes a change to the source field.
